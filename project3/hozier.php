...
<body>
        ...
        <section class="table-container" id="Awards">
            ...
            <table border="1">
                ...
                <tr>
                    ...
                    <td>European Border Breakers Awards</td>
                </tr>
                <tr>
                    <td>2015</td>
                    <td>Take Me to Church</td>
    ...
    <footer>
        <section id="References">
            <h2>References</h2>
            <ul>
                <li><a href="https://en.wikipedia.org/wiki/Hozier" target="_blank">Wikipedia</a></li>
                <li><a href="https://hozier.com/" target="_blank">Hozier's Website</a></li>
            </ul>

            <div>&copy; 2025 Niharika Agrawal</div>
            <p>Content source: <a href="https://betaweb.csug.rochester.edu/~nagrawa5/project2/index.html" target="_blank">View Original Webpage</a></p>
        </section>
    </footer>
